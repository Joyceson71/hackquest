        ...
        <header className="sticky top-0 z-50 glass-panel border-b-0 border-x-0 border-t-0 rounded-none bg-[#09090b]/70">
          <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
            <a href="/meetings/new" className="flex items-center gap-3 group">
              ...
              <span className="text-2xl font-heading font-black text-foreground tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">MeetingCompiler</span>
            </a>
